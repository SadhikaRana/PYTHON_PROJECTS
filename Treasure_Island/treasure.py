...
if ch1 == "left" :
    ch2 = input ("You've come to a lake. There is an island in the middle of the lake. "
                 "Type 'wait' to wait for a boast. "
                 "Type 'swim' to swim across").lower()
    if ch2 == 'wait':
        ch3 = input("You arrive at the island unharmed. There is house with 3 doors. "
